...
**Evaluation Scores (auto-generated by LLM judge):**

| Field | Type | Description |
|-------|------|-------------|
| faithfulness_score | float | 0.0-1.0: Does answer match source_data? |
| relevance_score | float | 0.0-1.0: Does answer address the question? |
| completeness_score | float | 0.0-1.0: Does answer cover key facts? |
| confidence_score | float | 0.0-1.0: min(faithfulness, relevance, completeness) |
...
- Source type
- Complexity level
- Confidence score (prioritize low-confidence for careful review)
- Suggested decision (filter to `needs_review` for focused attention)
